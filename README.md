# `tree_sitter_css_jll.jl` (v0.25.0+0)

[![deps](https://juliahub.com/docs/tree_sitter_css_jll/deps.svg)](https://juliahub.com/ui/Packages/General/tree_sitter_css_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f16d144120d6ffabf2730bef30e52a4969776b88/T/tree_sitter_css/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `tree_sitter_css_jll.jl` have been built from these sources:

* git repository: https://github.com/tree-sitter/tree-sitter-css.git (revision: `dda5cfc5722c429eaba1c910ca32c2c0c5bb1a3f`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/f16d144120d6ffabf2730bef30e52a4969776b88/T/tree_sitter_css/bundled)

## Platforms

`tree_sitter_css_jll.jl` is available for the following platforms:
...
* `LibraryProduct`: `libtreesitter_css`
